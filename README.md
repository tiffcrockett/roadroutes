...
4. The All-Routes page lists of all routes or search the database to show route by City, State and SORT by route area or distance.  
...
9. Enter route information on the Add-Route page and SAVE.  You will have the option to include the route to Your Saved Routes.
